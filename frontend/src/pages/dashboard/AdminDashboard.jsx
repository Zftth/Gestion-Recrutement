  ...
  return (
    <div className="flex-1">
      ...
      <div className="bg-white shadow-sm border-b border-gray-200 p-6">
        ...
        <p className="text-gray-600 mt-1">Vue d'ensemble de votre activité de recrutement</p>
      </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-600 text-sm mb-3">
                    Voir vos graphiques et analyses
                  </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200">
            <div className="p-6 border-b border-gray-200">
              ...
              <p className="text-sm text-gray-600">Les dernières candidatures reçues</p>
            </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200">
            <div className="p-6 border-b border-gray-200">
              <h2 className="text-lg font-semibold text-gray-900">Entretiens à Venir</h2>
              <p className="text-sm text-gray-600">Prochains entretiens programmés</p>
            </div>
            <div className="p-6 space-y-4">
